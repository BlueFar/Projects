...
public class AdminPickupReturnDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_pickup_return_details);
        ...
        biddername = (TextView) findViewById(R.id.admin_pickup_return_details_buyer_name);
        ...
        DocumentReference productRef =db.collection("Admins").document(adminid).collection("Pickup")
                .document("ToReturn").collection("Details").document(productid);
        productRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                sellernumber = documentSnapshot.getString("BidderNumber");
                biddernumber = documentSnapshot.getString("SellerNumber");
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AdminPickupReturnDetails.this, AdminPickupReturn.class);
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        dref1.update("OrderStatus", "Returned").addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        dref4.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                Toast.makeText(AdminPickupReturnDetails.this, "Updated", Toast.LENGTH_SHORT).show();
                                                Intent intent = new Intent(AdminPickupReturnDetails.this, AdminHomePage.class);
                                                startActivity(intent);
                                                finish();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                dref9.update("OrderStatus", "Received");
                                                ...
                                                Toast.makeText(AdminPickupReturnDetails.this, "Unable to Confirm, please try again later", Toast.LENGTH_SHORT).show();
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                dref6.update("OrderStatus", "Received");
                                Toast.makeText(AdminPickupReturnDetails.this, "Unable to Confirm, please try again later", Toast.LENGTH_SHORT).show();
