...
public class SellDeviceRegister3 extends AppCompatActivity {
    ...
    String frontpictemp,backpictemp,productid;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sell_device_register3);

        backbutton = (ImageView) findViewById(R.id.sell_register_back_button3);
        imageupload = (ImageView) findViewById(R.id.sell_register_image_upload3);
        browse = (ImageView) findViewById(R.id.sell_register_browse3);
        ...
        imageupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    if (ContextCompat.checkSelfPermission(SellDeviceRegister3.this,
                            Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(SellDeviceRegister3.this,
                        ...
                        if (photoFile != null) {
                            ...
                            picbill = FileProvider.getUriForFile(SellDeviceRegister3.this, "in.trueowner.fileprovider", photoFile);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            builder1.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ActivityCompat.requestPermissions(SellDeviceRegister3.this,
    ...
    private void finaloutcome1() {
        ...
        if (read.equals(true)) {
            ...
            Toast.makeText(SellDeviceRegister3.this, "Dont have the permission", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == Camera_Request_code && resultCode == RESULT_OK) {
            ...
            if (picbill != null) {
                ...
                Toast.makeText(SellDeviceRegister3.this, "Image selected", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(SellDeviceRegister3.this, SellDeviceRegister4.class);
                intent.putExtra("FrontPic", frontpictemp);
                intent.putExtra("BackPic", backpictemp);
                intent.putExtra("LeftPic", picbill.toString());
                ...
                Toast.makeText(SellDeviceRegister3.this, "Image not selected", Toast.LENGTH_SHORT).show();
