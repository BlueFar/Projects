...
public class LostRegisterDevice2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lost_register_device2);

        backbutton = (ImageView) findViewById(R.id.register_back_button);
        brand = (EditText) findViewById(R.id.lost_register_brand);
        model = (EditText) findViewById(R.id.lost_register_model);
        imei1 = (EditText) findViewById(R.id.lost_register_imei_1);
        imei2 = (EditText) findViewById(R.id.lost_register_imei_2);
        serialno = (EditText) findViewById(R.id.lost_register_serial_no);
        submitbutton = (Button) findViewById(R.id.lost_register_submit_button);
    ...
    public void register(){
        ...
        if(!validate()){
            ...
            Intent intent = new Intent(LostRegisterDevice2.this, LostRegisterDevice3.class);
