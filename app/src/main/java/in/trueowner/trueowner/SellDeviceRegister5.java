...
public class SellDeviceRegister5 extends AppCompatActivity {
    ...
    String frontpictemp,backpictemp,leftpictemp,rightpictemp,productid;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sell_device_register5);

        backbutton = (ImageView) findViewById(R.id.sell_register_back_button5);
        imageupload = (ImageView) findViewById(R.id.sell_register_image_upload5);
        browse = (ImageView) findViewById(R.id.sell_register_browse5);
        ...
        imageupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    if (ContextCompat.checkSelfPermission(SellDeviceRegister5.this,
                            Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(SellDeviceRegister5.this,
                        ...
                        if (photoFile != null) {
                            ...
                            picbill = FileProvider.getUriForFile(SellDeviceRegister5.this, "in.trueowner.fileprovider", photoFile);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            builder1.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ActivityCompat.requestPermissions(SellDeviceRegister5.this,
    ...
    private void finaloutcome1() {
        ...
        if (read.equals(true)) {
            ...
            Toast.makeText(SellDeviceRegister5.this, "Dont have the permission", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == Camera_Request_code && resultCode == RESULT_OK) {
            ...
            if (picbill != null) {
                ...
                Toast.makeText(SellDeviceRegister5.this, "Image selected", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(SellDeviceRegister5.this, SellDeviceRegister6.class);
                ...
                intent.putExtra("BottomPic", picbill.toString());
                intent.putExtra("ProductID", productid);
                startActivity(intent);

            }  else {

                Toast.makeText(SellDeviceRegister5.this, "Image not selected", Toast.LENGTH_SHORT).show();
