...
public class RegisterDevicePage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.register_device_page3);
        ...
        imageupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    if (ContextCompat.checkSelfPermission(RegisterDevicePage3.this,
                            Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(RegisterDevicePage3.this,
                        ...
                        if (photoFile != null) {
                            ...
                            picbill = FileProvider.getUriForFile(RegisterDevicePage3.this, "in.trueowner.fileprovider", photoFile);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            builder1.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ActivityCompat.requestPermissions(RegisterDevicePage3.this,
