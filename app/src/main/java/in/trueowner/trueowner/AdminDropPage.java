...
public class AdminDropPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_drop_page);
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(AdminDropPage.this, AdminHomePage.class);
        ...
        pickupseller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(AdminDropPage.this, AdminDropBuyer.class);
                startActivity(intent1);
        ...
        pickupcourier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(AdminDropPage.this, AdminDropCourier.class);
                startActivity(intent1);
        ...
        pickupreturned.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(AdminDropPage.this, AdminDropSeller.class);
                startActivity(intent1);
            ...
            Intent intent1 = new Intent(AdminDropPage.this, LoginPage.class);
            startActivity(intent1);
            finish();
