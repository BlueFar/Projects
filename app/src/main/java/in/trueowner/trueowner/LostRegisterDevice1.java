...
public class LostRegisterDevice1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lost_register_device1);

        backbutton = (ImageView) findViewById(R.id.lost_register_back_button3);
        ...
        imageupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    if (ContextCompat.checkSelfPermission(LostRegisterDevice1.this,
                            Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(LostRegisterDevice1.this,
                        ...
                        if (photoFile != null) {
                            ...
                            picbill = FileProvider.getUriForFile(LostRegisterDevice1.this, "in.trueowner.fileprovider", photoFile);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            builder1.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ActivityCompat.requestPermissions(LostRegisterDevice1.this,
    ...
    private void finaloutcome1() {
        ...
        if (read.equals(true)) {
            ...
            Toast.makeText(LostRegisterDevice1.this, "Dont have the permission", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == Camera_Request_code && resultCode == RESULT_OK) {
            ...
            if (picbill != null) {
                ...
                Toast.makeText(LostRegisterDevice1.this, "Image selected", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(LostRegisterDevice1.this, LostRegisterDevice2.class);
                ...
                Toast.makeText(LostRegisterDevice1.this, "Image not selected", Toast.LENGTH_SHORT).show();
